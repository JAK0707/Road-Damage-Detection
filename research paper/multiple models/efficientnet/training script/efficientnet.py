...
class PotholeModel(pl.LightningModule):
    def __init__(self, learning_rate=1e-3):
        ...
        # Replace ResNet50 with EfficientNet-B0
        self.model = efficientnet_b0(pretrained=True)
        self.model.classifier[1] = nn.Linear(self.model.classifier[1].in_features, 1)  # Single output for binary classification
...
def main(data_dir, epochs=10, batch_size=16):
    ...
    torch.save(model.state_dict(), "pothole_model_efficientnet.pth")
